...
const mockPost = {
  ...
  subtitle: 'Learn how to build modern web applications with the latest version of Next.js',
  content: `Next.js 14 brings exciting new features and improvements that make building web applications easier and more performant than ever. In this comprehensive guide, we'll explore everything you need to know to get started.

## What's New in Next.js 14

The latest version introduces several groundbreaking features:

- **Turbopack** - A blazing fast bundler built in Rust
...
Next.js 14 represents a significant step forward in web development. With its improved performance and developer experience, it's never been better to build modern web applications.`,
  status: 'published',
  ...
  seo: {
    ...
    metaDescription: 'Learn how to build modern web applications with Next.js 14. Complete tutorial covering all new features including Turbopack, Server Actions, and more.',
...
export default function BlogPostEditorPage() {
  ...
  const [subtitle, setSubtitle] = useState(mockPost.subtitle)
  const [content, setContent] = useState(mockPost.content)
  const [status, setStatus] = useState(mockPost.status)
  const [scheduledDate, setScheduledDate] = useState('')
  const [selectedCategories, setSelectedCategories] = useState<string[]>(mockPost.categories)
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-1">
                ...
                <Input defaultValue={mockPost.seo.metaTitle} />
                <span className="text-xs text-text-muted">{mockPost.seo.metaTitle.length}/60 characters</span>
              </div>
              <div className="space-y-1">
                <label className="text-sm font-medium">Meta description</label>
                <Textarea defaultValue={mockPost.seo.metaDescription} className="min-h-[80px]" />
                <span className="text-xs text-text-muted">{mockPost.seo.metaDescription.length}/160 characters</span>
              </div>
              <div className="space-y-1">
                <label className="text-sm font-medium">URL slug</label>
                <Input defaultValue={mockPost.seo.slug} />
              </div>
